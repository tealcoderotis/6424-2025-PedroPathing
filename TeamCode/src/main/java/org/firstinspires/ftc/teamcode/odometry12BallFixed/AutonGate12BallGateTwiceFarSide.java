...
@Configurable
@Autonomous(name = "Odometry 12 Ball Auton (Gate 2x; observation zone)")
public class AutonGate12BallGateTwiceFarSide extends LinearOpMode {
        ...
        switch (pathState) {
            ...
            case 11:
                if ((!follower.isBusy()) || maxIntakeTimer.getElapsedTime() >= Globals.MAX_INTAKE_TIME) {
                    ...
                    shooterIntake.stopIntaking();
                    follower.setMaxPower(1);
                    follower.followPath(paths.RedRow2Gate1);
                    pathState = 12;
                }
                break;
            case 12:
            ...
            case 20:
                if (!shooterIntake.isBusy()) {
                    follower.followPath(paths.RedFarIntakeBeginFromShooter);
                    pathState = 21;
                }
                break;
            case 21:
        ...
        switch (pathState) {
            ...
            case 11:
                if ((!follower.isBusy()) || maxIntakeTimer.getElapsedTime() >= Globals.MAX_INTAKE_TIME) {
                    ...
                    shooterIntake.stopIntaking();
                    follower.setMaxPower(1);
                    follower.followPath(paths.BlueRow2ToGate);
                    pathState = 12;
                }
                break;
            case 12:
            ...
            case 20:
                if (!shooterIntake.isBusy()) {
                    follower.followPath(paths.BlueFarIntakeBeginFromShooter);
                    pathState = 21;
                }
                break;
            case 21:
