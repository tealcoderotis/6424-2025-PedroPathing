...
@Configurable
@Autonomous(name = "Odometry Far Leave Only Auton")
@Disabled
public class AutonFarLeave extends LinearOpMode {
    ...
    public void autonomousBluePathUpdate() {
        switch (pathState) {
            case 0:
                shooterIntake.beginReving(1950);
            ...
            case 2:
                if (!shooterIntake.isBusy()) {
                    follower.followPath(paths.BlueSimpleLeave);
                    pathState = 3;
                }
                break;
            case 3:
