...
import org.firstinspires.ftc.teamcode.TurretRotator;
import org.firstinspires.ftc.teamcode.pedroPathing.Constants;
import org.firstinspires.ftc.teamcode.util.Alliance;
import org.firstinspires.ftc.teamcode.util.LimelightPoseCorrector;

@Configurable
@Autonomous(name = "Odometry 12 Ball Auton (Rotating turret)")
public class AutonTurret extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        turretRotator = new TurretRotator(hardwareMap, alliance, telemetry);
        ...
        if (alliance != Alliance.UNKNOWN) {
            ...
            turretRotator.setAlliance(alliance);
            if (useLimelight) {
            ...
            while (opModeIsActive()) {
                ...
                follower.update();
                turretRotator.update(follower.getPose());
