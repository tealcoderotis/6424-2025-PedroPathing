package org.firstinspires.ftc.teamcode.odometry15Ball;
...
public class Paths {
    ...
    public Paths(Follower follower) {
        ...
        RedShooterToGate2 = follower
                .pathBuilder()
                .addPath(
                        new BezierCurve(new Pose(96, 95.8), new Pose(94, 64.3), new Pose(131.3, 61.5))
                )
        ...
        RedGateIntake = follower
                .pathBuilder()
                .addPath(
                        new BezierCurve(new Pose(131.3, 61.5), new Pose(132, 48))
                )
        ...
        RedLeave = follower
                .pathBuilder()
                .addPath(
                        new BezierLine(new Pose(96, 95.8), new Pose(110.000, 72))
                )
                .setLinearHeadingInterpolation(Math.toRadians(42), Math.toRadians(0))
                .build();
        ...
        BlueShooterToGate2 = follower
                .pathBuilder()
                .addPath(
                        new BezierCurve(new Pose(48, 95.8), new Pose(50, 64.3), new Pose(12.7, 61.5))
                )
        ...
        BlueGateIntake = follower
                .pathBuilder()
                .addPath(
                        new BezierLine(new Pose(12.7, 61.5), new Pose(12, 48))
                )
        ...
        BlueLeave = follower
                .pathBuilder()
                .addPath(
                        new BezierLine(new Pose(48, 95.8), new Pose(34, 72))
                )
                .setLinearHeadingInterpolation(Math.toRadians(138), Math.toRadians(180))
                .build();
